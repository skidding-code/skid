    ...
    },
    {
      ...
      intro: [
        ...
        },
        {
          type: "code",
          lang: "html",
          text: '<img src="https://picsum.photos/200" alt="A random photo" />',
        },
        {
          type: "callout",
          tone: "warn",
        ...
        {
          type: "p",
          text: 'Add an <img> with src "https://picsum.photos/200" and alt text that reads exactly: A random photo.',
        },
      ],
      starter: {
      ...
      checks: [
        ...
        { label: "Point its src at the photo", kind: "domAttrEquals", value: "img::src::https://picsum.photos/200" },
        { label: "Describe it with alt text", kind: "domAttrEquals", value: "img::alt::A random photo" },
      ],
      hints: [
        "An <img> needs both a src and an alt attribute.",
        'Start with: <img src="https://picsum.photos/200" ...',
        'The full tag is: <img src="https://picsum.photos/200" alt="A random photo" />',
      ],
