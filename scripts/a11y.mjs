...
const PAGES = [
  ...
  { name: "Course (TypeScript)", path: "/learn/typescript" },
  { name: "Paths gallery", path: "/paths", wait: ".path-card" },
  { name: "Path detail (TS frontend)", path: "/paths/ts-frontend", wait: ".pathchap" },
  { name: "Lesson (TypeScript)", path: "/lesson/ts-hello", wait: ".cm-editor" },
